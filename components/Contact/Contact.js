...
const formControls = [
  ...
  },
  {
    ...
    value: "",
    errors: [],
    rules: yup.string().required().email().max(255),
  },
  {
    isFocused: false,
...
class Contact extends Component {
  ...
  render() {
    ...
    return (
      <section className="bg-primary text-white mb-0" id="contact">
        <div className="container">
          <h2 className="text-center text-uppercase text-white mb-0">
            Contact Me
          </h2>
          <hr className="star-white mb-5" />
          <div className="row">
